...
public class LeadService {
    ...
    public Page<LeadResponseDTO> findByStatus(Pageable pageable, StatusLead status) {
        ...
        if (!user.getRole().getName().equals("GERENTE") || user.getRole().getName().equals("ADMIN") && status.equals(StatusLead.ENCERRADO)) {
    ...
    public LeadDashboardDTO getDashboard(UUID id) {
        ...
        boolean isGerente = user.getRole().getName().equals("GERENTE") || user.getRole().getName().equals("ADMIN");
        // 👇 null = todos os leads
